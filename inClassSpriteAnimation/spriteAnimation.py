...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, pos_x,pos_y, color):
        ...
        for i in range(6):
            #here we can use the "getColorImage" function at the bottom of this
            #code. It needs to be added to the class first. You can cut and paste
            #it to the bottom of this class
            self.sprites.append(self.getColorImage(pygame.image.load('skel_'+ '%01d' % i +'.png'),self.color))
        ...
        for i in range(8):
            self.jumpSprites.append(self.getColorImage(pygame.image.load('skeljmp_'+ '%01d' % i +'.png'),self.color))
...
player = Player(0,100,pygame.Color(255,255,255))
